...
**예시:** "엄마" → 엄마에게 전화 걸기, "음악" → 음악 재생, "불꺼" → 불 끄기

## 🚨 핵심 가치: 안전과 접근성

SoundToAct는 단순한 편의 기능을 넘어 **긴급 상황에서의 안전**과 **모두를 위한 접근성**을 제공합니다.

### 긴급 상황 대응
- 📱 **폰을 찾을 수 없을 때**: 위험한 상황에서 폰 화면을 보지 않고도 "엄마"라고 말하면 즉시 전화 연결
- 🚑 **손을 쓸 수 없을 때**: 넘어지거나 다쳤을 때 음성만으로 도움 요청
- 🎯 **빠른 대응**: UI 조작 없이 2초 이내 즉시 실행

### 접근성 지원
- 👴 **어르신**: 작은 글씨나 복잡한 UI를 몰라도 말만 하면 작동
- 💼 **바쁜 직장인**: 운전 중이나 멀티태스킹 중에도 안전하게 사용
- ♿ **장애인**: 시각 장애나 지체 장애가 있어도 음성만으로 완전 제어
