...
SLIDES = [
    ...
    # Slide 8: For Others Too - 다른 사람들도 (긴급 상황 포함)
    {
        ...
        "speaker_notes": "발표자 가이드: 안전과 사회적 가치 강조. '긴급 상황에서 진가를 발휘합니다' 시작. 위급할 때(넘어졌을 때, 사고 시) 폰 화면 못 봐도 '엄마'라고 말하면 즉시 전화 연결되어 도움 요청 가능. 각 그룹별 pain point 설명. '기술은 누구에게나 평등해야 합니다' 강조. 접근성(Accessibility)과 안전(Safety)이 핵심 가치임을 언급.",
        "estimated_time": 75
    },
